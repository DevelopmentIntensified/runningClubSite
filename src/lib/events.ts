...
export const eventTypes: EventTypeConfig[] = [
  ...
  },
  {
    ...
    chipRing: 'ring-teal-200/80'
  },
  {
    value: 'NIRCA Outdoor Race',
    label: 'NIRCA',
    chipBg: 'bg-red-100',
    chipText: 'text-red-900',
    chipRing: 'ring-red-200/80'
  },
  {
    value: 'NIRCA Indoor Race',
    label: 'NIRCA',
    chipBg: 'bg-red-100',
    chipText: 'text-red-900',
    chipRing: 'ring-red-200/80'
  ...
  {
    value: 'NCAA Outdoor Race',
    label: 'NCAA',
    chipBg: 'bg-blue-100',
    chipText: 'text-blue-900',
    chipRing: 'ring-blue-200/80'
  },
  {
    value: 'NCAA Indoor Race',
    label: 'NCAA',
    chipBg: 'bg-blue-100',
    chipText: 'text-blue-900',
    chipRing: 'ring-blue-200/80'
