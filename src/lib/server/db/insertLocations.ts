...
const locationData = [
  {
    name: 'Bellevue Rd',
    description:
      "A hilly gravel road about 6 miles long. We often do long runs here.",
  ...
  },
  {
    name: 'Poplar Forest',
    description:
      'A historical park that has several trails running through it.',
  ...
  },
  {
    ...
    description:
      'Where we do most of our workouts and meet regularly on Tuesday nights.',
