  ...
  <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    <div class="relative max-w-md flex-1">
      <input
        ...
        class="focus:border-primary-500 focus:ring-primary-500/20 w-full rounded-lg border border-gray-300 py-3 pr-4 pl-10 text-gray-900 shadow-sm transition-shadow focus:ring-2 focus:outline-none"
      />
      <svg
      ...
      {#each filteredLocations as location}
        ...
        >
          <div class="flex flex-1 flex-col p-6">
            <h3
              class="group-hover:text-primary-600 mb-2 text-xl font-bold text-gray-900 transition-colors"
            >
              {location.name}
            </h3>
            ...
            <div class="mt-auto flex gap-3">
              <button
                ...
                class="bg-primary-600 hover:bg-primary-700 focus:ring-primary-500 flex flex-1 items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-sm font-semibold text-white transition-all duration-200 focus:ring-2 focus:ring-offset-2 focus:outline-none"
              >
              ...
              <a
                ...
                class="focus:ring-primary-500 flex items-center justify-center rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 transition-all duration-200 hover:bg-gray-50 focus:ring-2 focus:ring-offset-2 focus:outline-none"
              >
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
