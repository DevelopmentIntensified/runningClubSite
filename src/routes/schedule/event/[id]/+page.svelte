    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      <div>
          ...
          {#if event.locationLink}
            <span class="inline-flex items-center gap-1">
              ...
              <a
                ...
                class="text-primary-700 hover:text-primary-900 inline-flex items-center gap-1 text-sm font-medium"
        ...
        {#if event.locationDescription}
          <p class="text-sm text-gray-500">{event.locationDescription}</p>
        {/if}
