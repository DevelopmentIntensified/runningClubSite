    ...
    {#if step === 'email'}
      ...
      >
        <p class="text-sm text-gray-600">
          Enter your Liberty email and we'll send you a reset code.
        </p>
        <div>
        ...
        <button
          type="submit"
          disabled={waiting}
          class="bg-primary-600 hover:bg-primary-700 focus:ring-primary-500 flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:opacity-50"
        >
          Send Reset Code
        </button>
        <div class="text-center">
          <a href="/login" class="text-primary-600 hover:text-primary-500 text-sm">Back to login</a>
        </div>
      </form>
    {:else}
      <form
      ...
      >
        <p class="text-sm text-gray-600">
          A code has been sent to your email. Enter it below with your new password.
        </p>
        <div>
