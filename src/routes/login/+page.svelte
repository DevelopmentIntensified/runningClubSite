    ...
    <form class="mt-3" on:submit|preventDefault={handleSubmit}>
      ...
      <div class="rounded-md shadow-sm">
        ...
        <h4 class="mt-2 text-center">
          ...
          <button
            disabled={waiting}
            class="ring-offset-background focus-visible:ring-ring text-primary-foreground mt-3 inline-flex h-10 w-full items-center justify-center whitespace-nowrap rounded-md bg-secondary px-4 py-2 text-sm font-medium transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
