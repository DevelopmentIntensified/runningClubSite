...
<svelte:head>
  <title>Add New Location - Liberty Running Club</title>
</svelte:head>
  ...
  <div class="mx-auto max-w-3xl">
    <div class="overflow-hidden rounded-lg bg-white shadow-xl">
      <div class="bg-primary-600 px-4 py-6 sm:px-6">
        <h2 class="text-center text-3xl font-extrabold text-white">Add New Location</h2>
      </div>
      <div class="p-6 sm:p-8">
        <form action="?/createLocation" method="POST" use:enhance class="space-y-6">
          <div>
          ...
          <div>
            ...
            <input
              id="order"
              name="order"
              value={data.locationsCount[0].count}
              class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm"
              >
          </div>
          <div>
